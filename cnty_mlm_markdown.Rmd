...
Use jags to complete bayesian estimates for the null model,
```{r, message=F,warning=F}
...
Before diganostic plots, let's take a look at the model results,
...
Posterior check of the last 10 parameters,
